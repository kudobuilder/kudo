...
./bin/kubectl-kudo init --webhook InstanceValidation --self-signed-webhook-ca-for-testing-only --dry-run --output yaml --kudo-image kudobuilder/controller:$VERSION \
