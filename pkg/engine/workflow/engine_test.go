	...
	tests := []struct {
		...
		{name: "plan in progress, will have plan/phase/step fatal error status, when a task fails with a fatal error", activePlan: &ActivePlan{
			...
			expectedStatus: &v1beta1.PlanStatus{
				...
				Name:    "test",
				Phases:  []v1beta1.PhaseStatus{{Name: "phase", Status: v1beta1.ExecutionFatalError, Message: "Error during execution: fatal error: default/test-instance failed in test.phase.step.task: dummy error", Steps: []v1beta1.StepStatus{{Status: v1beta1.ExecutionFatalError, Message: "Error during execution: fatal error: default/test-instance failed in test.phase.step.task: dummy error", Name: "step"}}}},
			},
			wantErr:  true,
			enhancer: testEnhancer,
		},
		{name: "plan in progress with a misconfigured task will fail with a fatal error", activePlan: &ActivePlan{
			...
			expectedStatus: &v1beta1.PlanStatus{
				Status:  v1beta1.ExecutionFatalError,
				Name:    "test",
				Message: "default/test-instance fatal error:  missing task test.phase.step.fake-task",
				Phases:  []v1beta1.PhaseStatus{{Name: "phase", Status: v1beta1.ExecutionFatalError, Message: "default/test-instance fatal error:  missing task test.phase.step.fake-task", Steps: []v1beta1.StepStatus{{Status: v1beta1.ExecutionFatalError, Message: "default/test-instance fatal error:  missing task test.phase.step.fake-task", Name: "step"}}}},
			},
			wantErr:  true,
			enhancer: testEnhancer,
		},
		{name: "plan in progress with an unknown task spec will fail with a fatal error", activePlan: &ActivePlan{
			...
			expectedStatus: &v1beta1.PlanStatus{
				...
				Phases:  []v1beta1.PhaseStatus{{Name: "phase", Status: v1beta1.ExecutionFatalError, Message: "default/test-instance fatal error:  failed to build task test.phase.step.task: unknown task kind Unknown", Steps: []v1beta1.StepStatus{{Status: v1beta1.ExecutionFatalError, Name: "step", Message: "default/test-instance fatal error:  failed to build task test.phase.step.task: unknown task kind Unknown"}}}},
			},
			wantErr:  true,
			enhancer: testEnhancer,
		},
		...
		{name: "plan in progress with multiple parallel steps, will stop the execution on the first fatal step error", activePlan: &ActivePlan{
			...
			expectedStatus: &v1beta1.PlanStatus{
				Status:  v1beta1.ExecutionFatalError,
				Name:    "test",
				Message: "Error during execution: fatal error: default/test-instance failed in test.phase.stepOne.taskOne: dummy error",
				Phases: []v1beta1.PhaseStatus{{Name: "phase", Status: v1beta1.ExecutionFatalError, Message: "Error during execution: fatal error: default/test-instance failed in test.phase.stepOne.taskOne: dummy error", Steps: []v1beta1.StepStatus{
		...
		{name: "plan in progress with multiple parallel phases, will stop the execution on the first fatal step error", activePlan: &ActivePlan{
			...
			expectedStatus: &v1beta1.PlanStatus{
				...
				Name:    "test",
				Phases: []v1beta1.PhaseStatus{
					{Name: "phaseOne", Status: v1beta1.ExecutionFatalError, Message: "Error during execution: fatal error: default/test-instance failed in test.phaseOne.step.taskOne: dummy error", Steps: []v1beta1.StepStatus{{Name: "step", Status: v1beta1.ExecutionFatalError, Message: "Error during execution: fatal error: default/test-instance failed in test.phaseOne.step.taskOne: dummy error"}}},
					{Name: "phaseTwo", Status: v1beta1.ExecutionInProgress, Steps: []v1beta1.StepStatus{{Name: "step", Status: v1beta1.ExecutionInProgress}}},
				},
			},
			wantErr:  true,
		...
		},
		{
			...
			expectedStatus: &v1beta1.PlanStatus{
				...
				Name:    "test",
				Message: "Error during execution: fatal error: default/test-instance failed in test.phase.step.task: dummy error",
				Phases:  []v1beta1.PhaseStatus{{Name: "phase", Status: v1beta1.ExecutionFatalError, Message: "Error during execution: fatal error: default/test-instance failed in test.phase.step.task: dummy error", Steps: []v1beta1.StepStatus{{Status: v1beta1.ExecutionFatalError, Name: "step", Message: "Error during execution: fatal error: default/test-instance failed in test.phase.step.task: dummy error"}}}}},
			wantErr:  true,
			enhancer: testEnhancer,
		},
	}
