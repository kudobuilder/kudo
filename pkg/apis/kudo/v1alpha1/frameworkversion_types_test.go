...
func TestFrameworkType_Validation(t *testing.T) {
	...
	expectedErrors := []string{
		...
		"ServiceSpec.Plans[].Phases:required: cannot be []",
		"ServiceSpec.Plans[].Strategy:required: cannot be ",
		"ServiceSpec.Plans[plan1].Phases:required: cannot be []",
		"ServiceSpec.Plans[plan2].Phases[0].Name:required: cannot be empty",
		"ServiceSpec.Plans[plan2].Phases[0].Steps:required: cannot be []",
		...
		"ServiceSpec.Plans[plan2].Phases[1].Steps[1].Tasks[0]:required: cannot be empty",
		...
		"ServiceSpec.Pods[].Uris:required: cannot be []",
		...
		"ServiceSpec.Pods[pod2].Networks[].ContainerPorts:required: cannot be []",
		"ServiceSpec.Pods[pod2].Networks[].HostPorts:required: cannot be []",
		...
		"ServiceSpec.Pods[pod2].Tasks[].Cpus:gte: cannot be 0",
		"ServiceSpec.Pods[pod2].Tasks[].Goal:required: cannot be <nil>",
		"ServiceSpec.Pods[pod2].Tasks[].MemoryMB:gte: cannot be 0",
		"ServiceSpec.Pods[pod2].Uris[0]:gt: cannot be empty",
		...
		"ServiceSpec.Pods[pod3].Uris:required: cannot be []",
	...
	expectedTaskErrors := []string{
		...
		"Task.Cpus:gte: cannot be -0.1",
		"Task.Gpus:gte: cannot be -1",
