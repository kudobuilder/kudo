...
func (c Initializer) verifyIsNotInstalled(client v1.CustomResourceDefinitionsGetter, crd *apiextv1.CustomResourceDefinition, result *verifier.Result) error {
...
func (c Initializer) getCrdForVerify(client v1.CustomResourceDefinitionsGetter, crdName string, result *verifier.Result) (*apiextv1.CustomResourceDefinition, error) {
	existingCrd, err := client.CustomResourceDefinitions().Get(context.TODO(), crdName, metav1.GetOptions{})
	if err != nil {
		if os.IsTimeout(err) {
			return nil, err
		}
...
func (c Initializer) verifyInstallation(client v1.CustomResourceDefinitionsGetter, crd *apiextv1.CustomResourceDefinition, result *verifier.Result) error {
...
func (c Initializer) verifyServedVersion(client v1.CustomResourceDefinitionsGetter, crdName, version string, result *verifier.Result) error {
...
func (c Initializer) apply(client v1.CustomResourceDefinitionsGetter, crd *apiextv1.CustomResourceDefinition) error {
	_, err := client.CustomResourceDefinitions().Create(context.TODO(), crd, metav1.CreateOptions{})
