...
// List lists all Operators in the indexer.
func (s *operatorLister) List(selector labels.Selector) (ret []*v1beta1.Operator, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.Operator))
	})
	return ret, err
}
...
// List lists all Operators in the indexer for a given namespace.
func (s operatorNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.Operator, err error) {
...
// Get retrieves the Operator from the indexer for a given namespace and name.
func (s operatorNamespaceLister) Get(name string) (*v1beta1.Operator, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("operator"), name)
	}
	return obj.(*v1beta1.Operator), nil
}
