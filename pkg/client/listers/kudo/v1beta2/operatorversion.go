...
type OperatorVersionLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta2.OperatorVersion, err error)
...
// List lists all OperatorVersions in the indexer.
func (s *operatorVersionLister) List(selector labels.Selector) (ret []*v1beta2.OperatorVersion, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta2.OperatorVersion))
	})
	return ret, err
}
...
type OperatorVersionNamespaceLister interface {
	...
	Get(name string) (*v1beta2.OperatorVersion, error)
...
// List lists all OperatorVersions in the indexer for a given namespace.
func (s operatorVersionNamespaceLister) List(selector labels.Selector) (ret []*v1beta2.OperatorVersion, err error) {
...
// Get retrieves the OperatorVersion from the indexer for a given namespace and name.
func (s operatorVersionNamespaceLister) Get(name string) (*v1beta2.OperatorVersion, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta2.Resource("operatorversion"), name)
	}
	return obj.(*v1beta2.OperatorVersion), nil
}
