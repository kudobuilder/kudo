...
import (
	...
	kudov1beta2 "github.com/kudobuilder/kudo/pkg/apis/kudo/v1beta2"
	...
	v1beta2 "github.com/kudobuilder/kudo/pkg/client/listers/kudo/v1beta2"
...
type OperatorVersionInformer interface {
	...
	Lister() v1beta2.OperatorVersionLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KudoV1beta2().OperatorVersions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KudoV1beta2().OperatorVersions(namespace).Watch(context.TODO(), options)
			},
		},
		&kudov1beta2.OperatorVersion{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *operatorVersionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kudov1beta2.OperatorVersion{}, f.defaultInformer)
}

func (f *operatorVersionInformer) Lister() v1beta2.OperatorVersionLister {
	return v1beta2.NewOperatorVersionLister(f.Informer().GetIndexer())
}
