	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KudoV1beta2().Instances(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KudoV1beta2().Instances(namespace).Watch(context.TODO(), options)
			},
		},
		&kudov1beta2.Instance{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *instanceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kudov1beta2.Instance{}, f.defaultInformer)
}

func (f *instanceInformer) Lister() v1beta2.InstanceLister {
	return v1beta2.NewInstanceLister(f.Informer().GetIndexer())
}
