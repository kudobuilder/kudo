	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KudoV1beta2().Operators(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KudoV1beta2().Operators(namespace).Watch(context.TODO(), options)
			},
		},
		&kudov1beta2.Operator{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *operatorInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kudov1beta2.Operator{}, f.defaultInformer)
}

func (f *operatorInformer) Lister() v1beta2.OperatorLister {
	return v1beta2.NewOperatorLister(f.Informer().GetIndexer())
}
