...
type OperatorVersionInterface interface {
	Create(ctx context.Context, operatorVersion *v1beta2.OperatorVersion, opts v1.CreateOptions) (*v1beta2.OperatorVersion, error)
	Update(ctx context.Context, operatorVersion *v1beta2.OperatorVersion, opts v1.UpdateOptions) (*v1beta2.OperatorVersion, error)
	UpdateStatus(ctx context.Context, operatorVersion *v1beta2.OperatorVersion, opts v1.UpdateOptions) (*v1beta2.OperatorVersion, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta2.OperatorVersion, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta2.OperatorVersionList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.OperatorVersion, err error)
...
func newOperatorVersions(c *KudoV1beta2Client, namespace string) *operatorVersions {
...
func (c *operatorVersions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta2.OperatorVersion, err error) {
	result = &v1beta2.OperatorVersion{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *operatorVersions) List(ctx context.Context, opts v1.ListOptions) (result *v1beta2.OperatorVersionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta2.OperatorVersionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("operatorversions").
...
func (c *operatorVersions) Create(ctx context.Context, operatorVersion *v1beta2.OperatorVersion, opts v1.CreateOptions) (result *v1beta2.OperatorVersion, err error) {
	result = &v1beta2.OperatorVersion{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("operatorversions").
...
func (c *operatorVersions) Update(ctx context.Context, operatorVersion *v1beta2.OperatorVersion, opts v1.UpdateOptions) (result *v1beta2.OperatorVersion, err error) {
	result = &v1beta2.OperatorVersion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("operatorversions").
...
func (c *operatorVersions) UpdateStatus(ctx context.Context, operatorVersion *v1beta2.OperatorVersion, opts v1.UpdateOptions) (result *v1beta2.OperatorVersion, err error) {
	result = &v1beta2.OperatorVersion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("operatorversions").
...
func (c *operatorVersions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.OperatorVersion, err error) {
	result = &v1beta2.OperatorVersion{}
