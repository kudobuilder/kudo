...
- Git
- Go `1.13` or later
- Install [golangci-lint](https://github.com/golangci/golangci-lint#binary-release) (make sure that the Go binaries path usually  `~/go/bin` is added to `$PATH` environment variable).
