    ...
    css.walkRules(rule => {
      rule.walkAtRules('apply', atRule => {
        ...
        const decls = (0, _lodash.default)(classes).reject(cssClass => cssClass === '!important').flatMap(cssClass => {
          ...
          return _lodash.default.reduce([() => findClass(classToApply, classLookup, onError), () => findClass(classToApply, shadowLookup, onError), () => findClass((0, _prefixSelector.default)(config.prefix, classToApply), shadowLookup, onError), () => {
            // prettier-ignore
