...
func main() {
	...
	log.Printf("Setting up conversion webhook")
	...
	// No need to call the same for OV and I, the registered webhook takes care of all CRDs

	log.Printf("Conversion webhook set up")
